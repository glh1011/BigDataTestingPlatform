...
export const getInfo = () => {
  ...
  var url = "http://192.168.0.216:8080/userPermission/querySubPermissions?id="+id;
  return (dispatch) => {
...
export const submitForm = (value,id,history) => {
  console.log(value)
  var url = "http://192.168.0.216:8080/userPermission/giveAndCancelAuthority?id="+id+"&opNames="+value;
  return (dispatch) => {
    axios.post(url)
